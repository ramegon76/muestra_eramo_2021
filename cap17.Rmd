...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Veracruz, Xalapa, Actopan y Alvarado.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/ver/muestra_ver_estab.xlsx).
...
me2 <- read.csv("estab/ver/muestra_ver_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/ver/muestra_ver_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -96.42490927437369, lat = 19.143110884920894, zoom = 9)  %>%
