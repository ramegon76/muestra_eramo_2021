...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Tuxtla Gutiérrez, Berriozábal, Chiapa de Corzo y Palenque.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/chia/muestra_chia_estab.xlsx).
...
me2 <- read.csv("estab/chia/muestra_chia_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/chia/muestra_chia_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -92.40513420602302, lat = 17.31263370681067, zoom = 8)  %>%
