...
La muestra para las entrevistas en establecimientos comprende unidades de observación del municipio de Morelia.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/mich/muestra_mich_estab.xlsx).
...
me2 <- read.csv("estab/mich/muestra_mich_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/mich/muestra_mich_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -101.19974737642178, lat = 19.700842902612507, zoom = 11)  %>%
