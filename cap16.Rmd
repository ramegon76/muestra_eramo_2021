...
La muestra para las entrevistas en establecimientos comprende unidades de observación del municipio de Victoria.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/tam/muestra_tam_estab.xlsx).
...
me2 <- read.csv("estab/tam/muestra_tam_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/tam/muestra_tam_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -99.14324746080183, lat = 23.743783832996897, zoom = 11)  %>%
