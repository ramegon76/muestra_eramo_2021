...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Celaya, Cortázar y Apaseo el Grande.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/gto/muestra_gto_estab.xlsx).
...
me2 <- read.csv("estab/gto/muestra_gto_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/gto/muestra_gto_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -100.81453129197617, lat = 20.530161775761847, zoom = 10)  %>%
