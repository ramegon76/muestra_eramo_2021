...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Pachuca, Mineral de la Reforma y Mineral del Monte.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/hgo/muestra_hgo_estab.xlsx).
...
me2 <- read.csv("estab/hgo/muestra_hgo_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/hgo/muestra_hgo_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -98.75979677175728, lat = 20.105625611254062, zoom = 11)  %>%
