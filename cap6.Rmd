...
La muestra para las entrevistas en establecimientos comprende unidades de observación del municipio de Chihuahua.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/chih/muestra_chih_estab.xlsx).
...
me2 <- read.csv("estab/chih/muestra_chih_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/chih/muestra_chih_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -106.07561634107167, lat = 28.645251672485312, zoom = 11)  %>%
