...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Tijuana, Ensenada y Playas de Rosarito.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/bc/muestra_bc_estab.xlsx).
...
me2 <- read.csv("estab/bc/muestra_bc_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/bc/muestra_bc_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -116.25701528980326, lat = 31.77079067974772, zoom = 8)  %>%
