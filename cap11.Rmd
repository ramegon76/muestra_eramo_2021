...
La muestra para las entrevistas en establecimientos comprende unidades de observación del municipio de Texcoco.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/mex/muestra_mex_estab.xlsx).
...
me2 <- read.csv("estab/mex/muestra_mex_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/mex/muestra_mex_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -98.85440235923514, lat = 19.52080444476951, zoom = 11)  %>%
