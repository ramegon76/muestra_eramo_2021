...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Guadalajara, Tlaquepaque, Tonalá y Zapopan.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/jal/muestra_jal_estab.xlsx).
...
me2 <- read.csv("estab/jal/muestra_jal_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/jal/muestra_jal_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -103.34694896974833, lat = 20.677681909182272, zoom = 10)  %>%
