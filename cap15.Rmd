...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Centro (Villahermosa), Teapa y Tacotalpa.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/tab/muestra_tab_estab.xlsx).
...
me2 <- read.csv("estab/tab/muestra_tab_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/tab/muestra_tab_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -92.94510100322805, lat = 17.801635075725446, zoom = 10)  %>%
