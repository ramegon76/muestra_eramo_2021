...
La muestra para las entrevistas en establecimientos comprende unidades de observación de diversas alcaldías de la Ciudad de México.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/cdmx/muestra_cdmx_estab.xlsx).
...
me2 <- read.csv("estab/cdmx/muestra_cdmx_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/cdmx/muestra_cdmx_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -99.16302533456796, lat = 19.406511829702506, zoom = 9)  %>%
