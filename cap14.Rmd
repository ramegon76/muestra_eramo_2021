...
La muestra para las entrevistas en establecimientos comprende unidades de observación del municipio de Culiacán.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/sin/muestra_sin_estab.xlsx).
...
me2 <- read.csv("estab/sin/muestra_sin_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/sin/muestra_sin_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -107.41224924118353, lat = 24.792256664150734, zoom = 11)  %>%
