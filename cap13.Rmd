...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Monterrey, Apodaca, Santa Catarina, General Escobedo, Guadalupe, San Nicolás de los Garza y San Pedro Garza García.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/nl/muestra_nl_estab.xlsx).
...
me2 <- read.csv("estab/nl/muestra_nl_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/nl/muestra_nl_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -100.30736071880399, lat = 25.732085916176004, zoom = 10)  %>%
