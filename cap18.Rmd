...
La muestra para las entrevistas en establecimientos comprende unidades de observación de los municipios de Zacatecas y Fresnillo.

A continuación se presenta el listado de establecimientos correspondiente a la muestra, mismo que puede descargarse [aquí](estab/zac/muestra_zac_estab.xlsx).
...
me2 <- read.csv("estab/zac/muestra_zac_estab.csv", header = T)
me2 <- me2[,-1]
...
puntos <- read.csv("estab/zac/muestra_zac_estab.csv")
puntos <- puntos[,-1]
...
m %>% setView(lng = -102.71193920812648, lat = 23.2, zoom = 9)  %>%
